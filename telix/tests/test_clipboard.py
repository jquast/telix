"""Tests for telix._clipboard and REPL clipboard handlers."""
...
# local
from telix._clipboard import _PASTE_COMMANDS, copy_to_clipboard, paste_from_clipboard
...
class TestReplClipboardHandlers:
    ...
    def test_copy_handler_copies_line(self):
        from telix.client_repl import _clipboard_copy

        editor = mock.MagicMock()
        editor.line = "hello world"
        with mock.patch("telix._clipboard.copy_to_clipboard") as m:
    ...
    def test_paste_handler_inserts_text(self):
        ...
        from telix.client_repl import _clipboard_paste

        editor = mock.MagicMock()
        editor.insert_text.return_value = LineEditResult(changed=True)
        with mock.patch("telix._clipboard.paste_from_clipboard", return_value="pasted"):
    ...
    def test_paste_handler_empty_clipboard(self):
        ...
        editor = mock.MagicMock()
        with mock.patch("telix._clipboard.paste_from_clipboard", return_value=""):
            result = _clipboard_paste(editor)
